...
void (function updateModules() {
  ...
  resolveStoreModules(require('@/store/mapState.js'), 'mapState.js')
  resolveStoreModules(require('@/store/mutation-types.js'), 'mutation-types.js')
  resolveStoreModules(require('@/store/modules/modelA.js'), 'modules/modelA.js')
  resolveStoreModules(require('@/store/modules/modelB.js'), 'modules/modelB.js')
  ...
  if (process.client && module.hot) {
    ...
    module.hot.accept([
      ...
      '@/store/modules/modelA.js',
      '@/store/modules/modelB.js',
    ], () => {
